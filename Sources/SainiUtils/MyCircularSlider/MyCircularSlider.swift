...
public protocol MYCircularSliderDelegate: MYCircularSliderProtocol {
    func circularSlider(_ slider: MYCircularSlider, valueChangedTo value: Double, fromUser: Bool)   // fromUser indicates whether the value changed by sliding the handle (fromUser == true) or through other means (fromUser == false)
    func circularSlider(_ slider: MYCircularSlider, startedTrackingWith value: Double)
    func circularSlider(_ slider: MYCircularSlider, endedTrackingWith value: Double)
    func circularSlider(_ slider: MYCircularSlider, directionChangedTo value: MYCircularSliderDirection)
    func circularSlider(_ slider: MYCircularSlider, revolutionsChangedTo value: Int)
}

extension MYCircularSliderDelegate {
    // Optional Methods
    func circularSlider(_ slider: MYCircularSlider, startedTrackingWith value: Double) {}
    func circularSlider(_ slider: MYCircularSlider, endedTrackingWith value: Double) {}
    func circularSlider(_ slider: MYCircularSlider, directionChangedTo value: MYCircularSliderDirection) {}
...
public enum MYCircularSliderDirection {
    case clockwise, counterclockwise, none
}


@objc(MYCircularSlider)
@IBDesignable
public class MYCircularSlider: UIControl {
    ...
    weak public var delegate: MYCircularSliderProtocol? = nil
    
    /** A middle ground for casting the delegate */
    private weak var castDelegate: MYCircularSliderDelegate? {
        get {
            return delegate as? MYCircularSliderDelegate
        }
        set {
            delegate = newValue
        }
    ...
    public var slidingDirection: MYCircularSliderDirection = .none
    ...
    let handle = MYCircularSliderHandle()
    ...
    public var handleType: MYCircularSliderHandleType {
        set {
    ...
    override public func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        func changeSlidingDirection(_ direction: MYCircularSliderDirection) {
